...
include_once('configPremium.php');
     ...
     $senha = $_POST['senha'];
      ...
      $result = mysqli_query($conexao, "INSERT INTO cadastro (nome,email,datanasc,cartao,cvv,senha) values ('$nome','$email','$datanasc','$cartao','$cvv','$senha')");
...
<head>
    <meta charset="UTF-8" />
    <title>Cad Premium</title>
    <link rel="stylesheet" type="text/css" href="estilocadastropremium.css">
</head>
<body>
    ...
    <main>
        ...
        <div class="box">
            <form action="cadastropremium.php" method='POST'>
                <fieldset>
                    <legend> <b> Cadastre-se para ter acesso aos cursos premium</b> </legend>
                    ...
                    <a href="loginpremium.php"> Já tem uma conta? Acesse aqui! </a>
